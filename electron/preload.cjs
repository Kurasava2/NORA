...
contextBridge.exposeInMainWorld('desktopAPI', {
  ...
  saveBinary: (bytes, suggestedName, filters) =>
    ipcRenderer.invoke('file:saveBinary', { bytes, suggestedName, filters }),
  ...
  logError: (scope, message) =>
    ipcRenderer.invoke('app:logError', { scope, message }),
  minimizeWindow: () => ipcRenderer.invoke('window:minimize'),
  maximizeWindow: () => ipcRenderer.invoke('window:maximize'),
  closeWindow: () => ipcRenderer.invoke('window:close'),
  completeClose: () => ipcRenderer.invoke('window:completeClose'),
